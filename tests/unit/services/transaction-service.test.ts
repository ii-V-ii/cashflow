...
describe('createTransactionService', () => {
  beforeEach(() => {
    ...
    mockRepos.findAccountById.mockResolvedValue({
      id: 'acc_1', name: '신한', type: 'bank', currentBalance: 1000000,
  ...
  it('이체 시 도착 계좌를 검증한다', async () => {
    const secondAccount = {
      id: 'acc_2', name: '국민', type: 'bank' as const, currentBalance: 500000,
...
describe('getTransactionByIdService', () => {
  it('존재하는 거래를 반환한다', async () => {
    mockRepos.findTransactionById.mockResolvedValue({ id: 'tx_1', amount: 10000 })
